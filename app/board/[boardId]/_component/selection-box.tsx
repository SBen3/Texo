...
interface SelectionBoxProps {
  onResizeHandlePointerDown: (side: Side, bounds: XYWH) => void;
}
...
export const SelectionBox = memo(
  ({ onResizeHandlePointerDown }: SelectionBoxProps) => {
    ...
    const isShowingHandles = useStorage(
      (root) =>
        soleLayerId &&
        /* root.layers.get(soleLayerId) */ root.layers[soleLayerId]?.type !==
          LayerType.Path,
    );
          ...
          <>
            ...
            <rect
              ...
              style={{
                ...
                width: `${HANDLE_WIDTH}px`,
                height: `${HANDLE_WIDTH}px`,
                transform: `translate(${bounds.x - HANDLE_WIDTH / 2 + bounds.width/2}px, ${bounds.y - HANDLE_WIDTH / 2}px)`,
              }}
              onPointerDown={(e) => {
                e.stopPropagation();
              }}

  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative flex min-h-[360px] items-center justify-center">
          ...
          <div className="relative flex h-64 w-72 -rotate-1 flex-col gap-3 rounded-2xl border border-border bg-card p-5 shadow-card sm:h-72 sm:w-80">
            ...
            <div className="flex flex-1 items-center justify-center gap-3">
              <div className="flex size-16 rotate-6 items-center justify-center rounded-xl bg-blush text-magenta">
                <StickyNote size={22} />
              </div>
              <div className="flex size-16 items-center justify-center rounded-xl bg-ice text-lime-500">
                <Square size={22} />
              </div>
              <div className="flex size-16 rotate-6 items-center justify-center rounded-full bg-lavender text-iris">
                <Circle size={22} />
              </div>
            </div>
      ...
      <section className="border-y border-border bg-muted py-10">
        ...
        <div className="mx-auto max-w-5xl overflow-hidden mask-[linear-gradient(to_right,transparent,black_15%,black_85%,transparent)]]">
      ...
      <section className="border-b border-border">
        <div className="mx-auto grid max-w-6xl grid-cols-2 lg:grid-cols-4">
          {STATS.map((stat) => (
            <div
              key={stat.label}
              className="flex flex-col items-center justify-center gap-1 border-border px-4 py-10 text-center not-last:border-r nth-[-n+2]:border-b lg:nth-[-n+2]:border-b-0"
            >
